[center][color=red][size=16pt][b]Google Member Map 2.0.8[/b][/size][/color]
[/center]
...
Spuds - [i]Assumed Mod ownership for RC4[/i]
...
Before installing it is recommended to make a backup of member and settings tables for your forum since it modifies them. 

Once installed you will want to go to Features and Options to enable it, along with entering a Google map API key. The key is required by the Google Maps API, and can be acquired at, http://www.google.com/apis/maps/signup.html
